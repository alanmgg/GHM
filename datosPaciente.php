<?php
    ...
    $query = "SELECT aPaterno, aMaterno, name, direction, email, telephone, age FROM pacientesregistro WHERE number = $number";

    $paciente = $conn->query($query)->fetchAll(PDO::FETCH_ASSOC);
                    ...
                    <form id="appointment-form" role="form" method="post" action="#">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="col-md-12 col-sm-12">
                                ...
                                <input type="text" class="form-control" id="direction" name="direction" value="<?php echo $datos['direction']; ?>" placeholder="" readonly>
                                <label for="email">Correo</label>
                                <input type="text" class="form-control" id="email" name="email" value="<?php echo $datos['email']; ?>" placeholder="" readonly>
                            </div>

                            <div class="col-md-6 col-sm-6">
                                <label for="telephone">Teléfono</label>
                                <input type="number" class="form-control" id="telephone" name="telephone" value="<?php echo $datos['telephone']; ?>" placeholder="" readonly>
                            </div>

                            <div class="col-md-6 col-sm-6">
                                <label for="age">Edad</label>
                                <input type="number" class="form-control" id="age" name="age" value="<?php echo $datos['age']; ?>" placeholder="" readonly>
                            </div>
