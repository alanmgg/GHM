...
if (!empty($_POST['email']) && !empty($_POST['number'])) {
    ...
    if (count($results) > 0 && $_POST['number'] == $results['number']) {
                ...
                <div class="col-md-6 col-sm-6">
                    ...
                    <form id="appointment-form" role="form" method="post" action="#">
                        ...
                        <div class="wow fadeInUp" data-wow-delay="0.8s">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <label for="number">Numero de seguro</label>
                                <input type="text" class="form-control" id="number" name="number" placeholder="Tu numero de seguro">
                                <button type="submit" class="form-control" id="cf-submit" name="submit">Iniciar</button>
                                <br><br>
                                <p>¿Eres doctor? <span><a href="login.php">Inicia sesíon aquí</a></span></p>
                            </div>
                        </div>
                    </form>
                </div>
